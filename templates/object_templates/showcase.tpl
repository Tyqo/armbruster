...
<section class="showcase">
	<div class="divider early-break outer-border">
		<div class="divider__aside divider">
			<div class="divider__aside divider dont-break">
				<figure class="divider__aside figure">
					{IMAGE:1:media/layoutmode}
				</figure>
				<figure class="divider__aside figure">
					{IMAGE:2:media/layoutmode}
				</figure>
			</div>
			<div class="divider__aside divider dont-break">
				<figure class="divider__aside figure">
					{IMAGE:3:media/layoutmode}
				</figure>
				<figure class="divider__aside figure">
					{IMAGE:4:media/layoutmode}
				</figure>
			</div>
		</div>
		<article class="divider__article">
			...
			<div class="divider">
				<article class="divider__article">
					{INCLUDE:PATHTOWEBROOT.'templates/object_templates/BA/sortiment.tpl'}
				</article>
				<article class="divider__article">
					{INCLUDE:PATHTOWEBROOT.'templates/object_templates/BA/contakt.tpl'}
				</article>
			</div>
		</article>
	</div>
